                    ...
                    <div class="box">
                        <a href="case1.html" style="width: 360px">
                            <div class="cases-link">
                                <img src="{{ $p->image }}" width="236px" height="236px">
                            ...
                            <a style="position: relative; top:-19px; left: 90px; text-decoration: none; font-size: 20px;" href="/kiemtra/public/edit/{{$p->id}}">Edit</a>
                        </a>
                    </div>
                @endforeach
            </div>
...
<div class="wrapper">
    <footer style="background: #F2F2F2">
        ...
        <h3>Đường dẫn ảnh</h3><input type="text" name="image" placeholder="url" style="width: 300px; height: 30px; border-radius: 10px; border: none; padding-left: 10px"><br>
